...
public class SwaggerConfig {
    ...
    private ApiInfo getApiInfo() {
        ...
        Contact contact = new Contact("Lovemesomecoding", "https://lovemesomecoding.com", "folau@gmail.com");

        return new ApiInfoBuilder().title("Rest API").description("API").version("1.0.0").contact(contact).build();
    }
